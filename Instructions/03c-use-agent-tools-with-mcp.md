...
## Criar um projeto da Fábrica da Microsoft
...
1. Copie o valor do **ponto de extremidade do projeto da Fábrica**. Você usará esse ponto de extremidade para se conectar ao projeto em um aplicativo cliente.
...
1. Aguarde o agente processar seu prompt, usando o servidor MCP para encontrar uma ferramenta adequada para recuperar as informações solicitadas. Você verá algo semelhante à seguinte saída:
    ...
    Observe que o agente foi capaz de invocar a ferramenta MCP `microsoft_code_sample_search` automaticamente para atender à solicitação.
